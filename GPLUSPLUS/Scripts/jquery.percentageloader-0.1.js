        ...
        * than true / false */
        ...
        drawLoader = function () {
            ...
            (function () {
                ...
                //if (parseFloat(progress) >= 0.01) {
                //    string =Math.round( parseFloat((progress * 100.0)).toFixed(1) + '%';
                //}
                //if (parseFloat(progress) < 0.01) {
                //    string = parseFloat((progress * 100.0)).toFixed(3) + '%';
                //}
                string = (progress * 100.0).toFixed(3) + '%';
